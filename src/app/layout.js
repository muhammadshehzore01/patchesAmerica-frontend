...
// Google Fonts via Next.js (variable + swap)
...
export const metadata = {
  ...
  description:
    "Premium custom patches USA – embroidered, PVC, chenille, woven & leather. No minimum order, fast US production & shipping. High-quality custom patches for jackets, hats, bags, military, sports teams & businesses.",
  keywords:
...
const MemoizedBodyWrapper = memo(BodyWrapper);
  ...
  return (
    ...
    >
      ...
      <body className="antialiased overflow-x-hidden font-sans">
        <GlobalModalProvider>
          <MemoizedBodyWrapper>{children}</MemoizedBodyWrapper>
        </GlobalModalProvider>
      </body>
    </html>
  );
